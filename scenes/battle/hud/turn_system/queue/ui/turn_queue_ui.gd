...
func _ready() -> void:
	...
	if not turn_queue_card_scene:
		turn_queue_card_scene = preload("res://scenes/battle/hud/turn_system/queue/cards/turn_queue_card.tscn")
	if not turn_queue_card_wrapper_scene:
		turn_queue_card_wrapper_scene = preload("res://scenes/battle/hud/turn_system/queue/cards/turn_queue_card_wrapper.tscn")
